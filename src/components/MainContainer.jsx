...
export default function MiainContainer({ data, title }) {
  ...
  return (
    <div className="lg:mx-12 md:mx-8 sm:mx-2 mx-2  my-6 ">
      ...
      <div className="flex overflow-x-scroll scroll  mb-14  scrollbar-hide">
        <LeftArrow />
          ...
          {data?.map((item) => {
            return (
              <MovieCard
                ...
                country={item.original_country || item.original_language.toUpperCase()}
                click={() =>
